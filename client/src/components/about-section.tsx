export default function AboutSection() {
  return (
    <section id="about" className="py-20 bg-light-gray" data-testid="about-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-navy mb-6" data-testid="about-title">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div data-testid="about-content">
            <h3 className="text-2xl font-semibold text-navy mb-6">Tradição e Inovação</h3>
