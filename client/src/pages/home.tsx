      ...
      <section id="areas" className="py-20 bg-white" data-testid="practice-areas-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-navy mb-6" data-testid="practice-areas-title">
              Áreas de Atuação
            </h2>
            <div className="w-24 h-1 bg-accent-gold mx-auto mb-8"></div>
            <p className="text-xl text-warm-gray">Conheça nossas especialidades jurídicas</p>
          </div>
